...
-- ------------------------------------------------------------
-- PASSWORD RESET REQUESTS: supplier temporary password flow
-- ------------------------------------------------------------
...
SET @sql := IF(@col_exists=0,
  'ALTER TABLE purchase_orders ADD COLUMN supplier_status ENUM(''Pending Confirmation'',''Confirmed'',''Processing'',''Shipped'',''In Transit'',''Delivered'',''Incomplete Delivery'') NOT NULL DEFAULT ''Pending Confirmation'' AFTER is_draft',
