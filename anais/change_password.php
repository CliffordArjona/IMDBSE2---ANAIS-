...
$stmt = $db->prepare("SELECT user_id, role, must_change_password FROM users WHERE user_id=? LIMIT 1");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strlen($newPassword) < 8) {
        ...
        // If this came from a temporary password reset request, remove the visible temp password note.
        try {
            ...
            // Do not block password change if this table is not available.
        }
...
<div class="login-page">
  <div class="login-card">
    <div class="login-logo login-logo-custom">
      ...
      <p>You are using a temporary password. Please create your own password before continuing.</p>
    </div>
    ...
    <div style="text-align:center;margin-top:14px">
      <a href="/anais/logout.php" style="color:var(--text-2);font-size:12px">Logout</a>
    </div>
  </div>
</div>
