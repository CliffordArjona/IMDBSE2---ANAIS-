...
-- ============================================================
-- PASSWORD RESET REQUESTS (Employee/OIC/Supplier temporary password reset)
-- ============================================================
CREATE TABLE password_reset_requests (
  ...
  CONSTRAINT fk_password_reset_user
    ...
    ON DELETE CASCADE,
  CONSTRAINT fk_password_reset_processed_by
...
CREATE TABLE stock_transactions (
  ...
  customer_id_no VARCHAR(80) DEFAULT NULL,
  ...
  replacement_qty MEDIUMINT UNSIGNED DEFAULT NULL,
  estimated_redelivery_date DATE DEFAULT NULL,
  supplier_redelivery_note TEXT DEFAULT NULL,
  redelivery_scheduled_at DATETIME DEFAULT NULL,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE purchase_orders (
  ...
  price_response_note TEXT DEFAULT NULL,
...
-- ============================================================
-- PO RETURNS / DAMAGED OR WRONG ITEMS
-- ============================================================
...
CREATE TABLE po_returns (
  ...
  KEY product_id (product_id),
  KEY recorded_by (recorded_by),
  CONSTRAINT fk_po_returns_po FOREIGN KEY (po_id) REFERENCES purchase_orders(po_id) ON DELETE CASCADE,
  CONSTRAINT fk_po_returns_product FOREIGN KEY (product_id) REFERENCES products(product_id) ON DELETE RESTRICT,
  CONSTRAINT fk_po_returns_user FOREIGN KEY (recorded_by) REFERENCES users(user_id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
